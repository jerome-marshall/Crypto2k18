...
class ThePrideActivity : AppCompatActivity() {
    ...
    private fun itemDecorate() {
        ItemTouchHelper(object : ItemTouchHelper.Callback() {
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder?, direction: Int) {
                val developerModal: DeveloperModal = DataForEvents.data1()[viewHolder!!.adapterPosition]
                val intent: Intent
            ...
            override fun onChildDrawOver(c: Canvas?, recyclerView: RecyclerView?, viewHolder: RecyclerView.ViewHolder?, dX: Float, dY: Float, actionState: Int, isCurrentlyActive: Boolean) {
                ...
                if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE) {
                    ...
                    val icon_dest: RectF
                    val paint = Paint()
                    paint.color = ContextCompat.getColor(this@ThePrideActivity, R.color.colorAccent)
                    if (dX > 0) {
                    ...
                    icon = if (developerModal.phoneNo != "")
                        getBitmapFromVectorDrawable(this@ThePrideActivity, R.drawable.ic_call_black_24dp)
                    else
                        getBitmapFromVectorDrawable(this@ThePrideActivity, R.drawable.ic_github)
    ...
    private fun setupRecyclerView() {
        recycler_view_developer?.layoutManager = LinearLayoutManager(this@ThePrideActivity, LinearLayoutManager.VERTICAL, false)
        recycler_view_developer?.setHasFixedSize(true)
        recycler_view_developer?.adapter = DeveloperAdapter(DataForEvents.data1(), this@ThePrideActivity)
    }
    ...
    private fun toast(text: String) {
        Toast.makeText(this@ThePrideActivity, text, Toast.LENGTH_LONG).show()
    }
